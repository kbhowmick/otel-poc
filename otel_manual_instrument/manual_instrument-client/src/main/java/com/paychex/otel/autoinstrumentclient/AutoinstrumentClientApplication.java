package com.paychex.otel.autoinstrumentclient;
...
public class AutoinstrumentClientApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(AutoinstrumentClientApplication.class, args);
	}
