package com.paychex.otel.autoinstrumentserver;
...
public class AutoinstrumentServerApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(AutoinstrumentServerApplication.class, args);
	}
