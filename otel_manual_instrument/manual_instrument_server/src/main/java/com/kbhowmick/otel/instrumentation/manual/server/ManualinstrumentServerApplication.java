package com.kbhowmick.otel.instrumentation.manual.server;
...
public class ManualinstrumentServerApplication {
	...
	static {
		...
		Resource resource =
			        Resource.create(Attributes.of(ResourceAttributes.SERVICE_NAME, "otel-poc-server"));
	...
	public static void main(String[] args) {
		SpringApplication.run(ManualinstrumentServerApplication.class, args);
	}
